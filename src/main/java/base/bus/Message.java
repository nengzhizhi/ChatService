...
import base.internal.bus.json.DefaultMessageMapper;
...
public final class Message<BODY> implements java.io.Serializable {
	...
	/*internal*/
	public Message(String channel,Long cid,BODY body,CheckError error) {
		this.data=body;
		this.cid=cid;
		this.c=channel;
 		this.error=error;
	...
	public final static class MessageSpec<BODY,REPLY> {
		private static MessageMapper<NoReply> NoReplyMapper=new MessageMapper<NoReply>(){
			...
			@Override public TypeRef<base.bus.Message.NoReply> getBodyType() {
				return new TypeRef<base.bus.Message.NoReply>(){};
			}};
		...
		/*internal*/ 
		public MessageMapper<BODY> getRequestMapper() {
			return requestMapper;
		}

		/*internal*/ 
		public MessageMapper<REPLY> getReplyMapper() {
			return replyMapper;
		}
